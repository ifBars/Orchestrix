...
## [What is RAG, Really?](#what-is-rag-really)
...
## [The Problems with RAG](#the-problems-with-rag)
...
## [Enter Memory Systems](#enter-memory-systems)
...
-   The system is **stateful** - it knows _who_ is asking and _what_ their history is
...
## [How Memory Systems Actually Work](#how-memory-systems-actually-work)
...
-   Follow relationship edges (e.g., "knows", "works\_at", "caused\_by", "related\_to")
...
_Example:_ Healthcare coverage: "Do I have dental coverage?"
...
_Example:_ Patient tracking: "My back still hurts, what should I try?"
...
-   **Memory:** Causal graph: ibuprofen → caused → stomach issues → resulted in → medication change → acetaminophen. Won't suggest ibuprofen. Knows the _why_ behind the current treatment (side effect, not ineffectiveness).
...
_Example:_ Dietary preferences: "Suggest a restaurant for dinner"
...
_Example:_ Real estate: "Show me apartments in the city"
...
## [The Drawbacks of Traditional Memory Implementations](#the-drawbacks-of-traditional-memory-implementations)
...
## [Supermemory - Memory at Scale](#supermemory-memory-at-scale)
...
### [Memory is NOT Just Retrieval](#memory-is-not-just-retrieval)
...
### [Facts-Based Architecture Under the Hood](#facts-based-architecture-under-the-hood)
