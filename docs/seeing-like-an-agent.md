# (20) Thariq on X: "Lessons from Building Claude Code: Seeing like an Agent " / X
...
![Image](https://pbs.twimg.com/media/HCLxg2JbsAA3Ag_?format=jpg&name=900x900)
...
[our post on prompt caching](prompt-caching.md)
...
![Image](https://pbs.twimg.com/media/HCL0gcObkAA4tKt?format=jpg&name=900x900)
...
![Image](https://pbs.twimg.com/media/HCLxrfXbEAUXwRV?format=jpg&name=900x900)
...
[read more on Tasks here](https://x.com/trq212/status/2014480496013803643)
