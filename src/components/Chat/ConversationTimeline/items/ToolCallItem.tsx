        ...
        <div className="mt-1 rounded-lg border border-border/40 bg-card/30 p-3">
          {item.toolArgs && Object.keys(item.toolArgs).length > 0 && (
            <div className="mb-2">
              ...
              <pre className="mt-1 max-h-32 overflow-auto rounded-md bg-background/60 p-2 text-xs text-muted-foreground">
          ...
          {item.toolResult && (
            <div className="mb-2">
              ...
              <pre className="mt-1 max-h-40 overflow-auto rounded-md bg-background/60 p-2 text-xs text-muted-foreground">
          ...
          {item.toolError && (
            <div>
              ...
              <pre className="mt-1 max-h-24 overflow-auto rounded-md bg-destructive/5 p-2 text-xs text-destructive">
