...
pub struct RunRow {
    ...
    // Note: Usage tracking fields added to DB in migration 9
    // but not included here to maintain backward compatibility.
    // Use get_run_cache_stats() to retrieve usage stats.
}
